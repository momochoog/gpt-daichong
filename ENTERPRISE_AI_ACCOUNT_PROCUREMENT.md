...
AIXiamo 可在企业自有独立账号上分批开通 Plus、Pro 5x，或为符合条件的账号新开、续订 Pro 20x。2026 年 9 月 20 日核对的 20x 零售方案为新开／续订统一 ¥1298：原非 App Store／Google Play 付款且当前仍显示 20x，可续订（包含逾期但订阅尚未消失）；目前没有 20x，但本人升级页能选择「Pro 20x」并进入付款页面，可新开。每个独立账号分别按[当前开通与续订条件](CHATGPT_PRO_20X_PAUSE_FAQ.md)核对；批量采购以确认报价为准。企业暂时无法准备账号时，也可在适用规则内按实际使用人数协助准备独立账号，账号准备与基础配置不额外收费，会员套餐和已确认服务仍按报价计费。
